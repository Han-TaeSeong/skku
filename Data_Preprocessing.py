...
def preprocessing_4_40Hz(file):
    ...
    for i in range(3, 4):
        ...
        b.filter(l_freq=8, h_freq=80)
        b.plot(n_channels=25, scalings=30)
        plt.show()
        b = b.get_data()
        for j in range(0, 48):
            beep = data[1].flatten()[j]  ##event
...
preprocessing_4_40Hz('.\\BCI_Competition_4_2a\\A04T.mat')
def make_data():
    # for i in range(1, 10):
    #     i = str(i)
    ...
    for i in range(1, 10):
        i = str(i)
        preprocessing_4_40Hz('.\\BCI_Competition_4_2a\\A0' + i + 'T.mat')
        preprocessing_4_40Hz('.\\BCI_Competition_4_2a\\A0' + i + 'E.mat')
